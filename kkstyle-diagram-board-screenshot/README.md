...
`kkstyle-diagram-board-screenshot` 是一个把文本内容整理成“信息图白板风”海报的 skill 包。它适合把项目介绍、流程拆解、工具说明、框架总结、步骤指南这类内容，做成一张结构清晰、可直接截图导出的 `3:4` 信息海报。
...
```text
Use $kkstyle-diagram-board-screenshot to make this feel like a structured infographic whiteboard.
```

如果你只想要 HTML：

```text
Use $kkstyle-diagram-board-screenshot and give me the HTML only.
```

如果你同时要 HTML 和 PNG：

```text
Use $kkstyle-diagram-board-screenshot to generate both the HTML and a PNG render.
```
...
```bash
/Users/bytedance/Downloads/Skills/kkstyle-skills/skills/kkstyle-diagram-board-screenshot/scripts/capture_card.sh \
  /Users/bytedance/Downloads/Skills/kkstyle-skills/skills/kkstyle-diagram-board-screenshot/assets/diagram-board-card-template.html \
