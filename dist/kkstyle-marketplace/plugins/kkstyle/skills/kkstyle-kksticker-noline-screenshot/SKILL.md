---
name: kkstyle-kksticker-noline-screenshot
description: "无描边吉祥物贴纸白板风海报。适合工具更新、功能拆解、亮点对照、双栏讲解；输出固定日期、二维码、IP 位的 HTML，并可截图为 PNG。"
...
默认优先产出 `3:4` 的 no-line kksticker poster：大标题、右上角高亮贴纸牌、摘要条、左右双栏内容板、底部能力标签，以及固定日期 + 固定二维码 + 固定卡卡 IP。
这个版本不使用明显粗黑描边，主要靠色块、阴影、留白和轻微边界差来区分层级。
