---
name: kkstyle-editorial-noline-screenshot
description: "把文章、笔记、提纲或摘要生成成偏杂志封面与编辑设计无描边、弱边界的信息海报 HTML，并可按固定比例截图为 PNG。Use when the user wants a no-line version, borderless version, softened-edge version, or an editorial poster, magazine-cover layout, high-contrast typography, modern print-inspired information design, or both HTML and image output in a more restrained direction than the default kkstyle styles."
metadata:
  clawdbot:
    requires:
      bins:
...
# KKStyle Editorial No-Line Screenshot
