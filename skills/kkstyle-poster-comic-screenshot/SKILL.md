...
description: "把文章、笔记、课程摘要或推荐清单生成成漫画海报风格的信息海报 HTML，并可按固定比例截图为 PNG。Use when the user wants a comic poster, pop-art cover, speech-bubble info card, bold cartoon-style layout, or both HTML and image output in a louder poster direction."
metadata:
  clawdbot:
    requires:
      bins:
