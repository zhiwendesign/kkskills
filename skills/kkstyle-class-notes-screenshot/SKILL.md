...
description: "把文章、笔记、课程摘要或推荐清单生成成手写课堂笔记风格的信息海报 HTML，并可按固定比例截图为 PNG。Use when the user wants a class notes poster, handwritten study board, marker-highlight layout, school notebook page, or both HTML and image output in a more note-like direction."
metadata:
  clawdbot:
    requires:
      bins:
