...
description: "把文章、笔记、课程摘要或推荐清单生成成暖米色纸张、胶带、撕纸、便签和杂志拼贴感的信息海报 HTML，并可按固定比例截图为 PNG。Use when the user wants a scrapbook collage poster, paper-note layout, cozy editorial board, handmade journal style, or both HTML and image output in a warmer alternative to the default kkstyle blue seal poster."
metadata:
  clawdbot:
    requires:
      bins:
